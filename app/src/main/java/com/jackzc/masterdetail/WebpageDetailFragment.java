package com.jackzc.masterdetail;
...
import com.jackzc.masterdetail.dummy.DummyContent;
...
public class WebpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ...
            // WebView view = (WebView) rootView.findViewById(R.id.page_details);
            // view.loadUrl(mItem.url);

            ((WebView)rootView.findViewById(R.id.page_details)).loadUrl(mItem.url);
